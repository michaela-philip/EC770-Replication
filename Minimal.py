...
natl2001_short = pd.read_fwf('./data/Natl2001.dat', colspecs = colspecs, header = None, nrows = 1000)
...
natl2002_short = pd.read_fwf(".data/Natl2002.dat", colspecs = colspecs, header = None, nrows = 1000)
...
natl2003_short = pd.read_fwf(".data/Nat03us.dat", colspecs = colspecs2, header = None, nrows = 1000)
